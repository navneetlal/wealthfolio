  ...
  return (
    <div className="flex flex-col gap-5 pb-2 pt-4">
      {isScanning &&
        createPortal(
          <div
            className="qr-overlay fixed inset-0 z-[10000] flex flex-col items-center justify-end overflow-hidden px-6 pb-[max(2rem,env(safe-area-inset-bottom))] pt-[max(2rem,env(safe-area-inset-top))] text-white"
            role="region"
            aria-label={t("sync:enterCode.scanQrCode")}
          >
            ...
            <Button
              ...
              onPointerDown={(event) => {
                ...
                // The controls sit outside the pairing modal's focus trap.
                // Cancel on the press before focus restoration can swallow the click.
